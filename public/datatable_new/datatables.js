 ...
 *   https://datatables.net/download/#bs5/dt-1.11.4/r-2.2.9/sb-1.3.1
 *
 * Included libraries:
 *   DataTables 1.11.4, Responsive 2.2.9, SearchBuilder 1.3.1
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs5/dt-1.11.4/r-2.2.9/sb-1.3.1",
