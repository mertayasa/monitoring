<div>
    <table class="table table-bordered skp" style="color: black; font-size:10px; padding:0; ">
        ...
        <tr>
            <td></td>
            <td></td>
            <td style=" line-height: 10px; ">9. DIBUAT TANGGAL,
        ...
        <tr>
            <td rowspan="17" style=" line-height: 20px ">
                10. DITERIMA TANGGAL, {{ indonesianDate($nilai_skp->tgl_selesai_penilaian) }}<br>
        ...
        <tr>
            <td></td>
            <td style=" line-height: 10px; ">c. Pangkat, Golongan Ruang, TMT</td>
        ...
        <tr>
            <td rowspan="6"></td>
            <td style=" line-height: 20px ">10. DITERIMA TANGGAL,
                {{ indonesianDate($nilai_skp->tgl_selesai_penilaian) }}</td>
            {{-- <td colspan="2"> 10. DITERIMA TANGGAL, {{ indonesianDate($nilai_skp->tgl_selesai_penilaian) }}</td> --}}
            <td>3. </td>
        ...
        <tr>
            ...
            <td rowspan="5"></td>
            <td>a. Nama</td>
            <td>Dr. Kn. Boy Jayawibawa, M.Si</td>
        </tr>
        <tr>
            <td>b. NIP</td>
            <td>19651130 199203 1 010</td>
        </tr>
        <tr>
            <td style=" line-height: 10px; ">c. Pangkat, Golongan Ruang, TMT</td>
        ...
        <tr>
            <td>e. Unit Organisasi</td>
            <td style=" line-height: 10px; ">Dinas Pendidikan Kepemudaan dan olahraga provinsi bali</td>
        </tr>
        ...
        <table class="table table-bordered" style="color: black; font-size:10px; padding:0; ">
            ...
            <tr>
                <td></td>
                <td>Nilai Prilaku Kerja</td>
                <td>{{ round($nilai_prilaku->nilai_rata, 2) }} </td>
                <td>40 %</td>
                <td>{{ round($nilai_prilaku->persen_prilaku, 2) }}</td>
                <td></td>
                <td></td>
                <td colspan="2"></td>
            </tr>
            ...
            <tr>
                ...
                <td>{{ round($nilai_prestasi_kerja, 2) }}</td>
            </tr>
            <tr>
                <td>( {{ getPredikatNilai(round($nilai_prestasi_kerja, 2)) }} )</td>
            </tr>
            ...
            <tr>
                <td colspan="6" rowspan="4" style="text-align:center; Padding-top:10px">
                    {{ $nilai_skp->keberatan }}
                    <br> Tanggal,
                </td>
