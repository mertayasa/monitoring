...
<div class="row mt-3">
    <div class="col-12 col-md-6 pb-3 pb-md-0">
        {!! Form::label('idPangkatGolongan', 'Pangkat Golongan', ['class' => 'mb-1']) !!}
        {!! Form::select('id_pangkat_golongan', $pangkat_golongan, null, ['class' => 'form-control', 'id' => 'idPangkatGolongan']) !!}  
    </div>
    <div class="col-12 col-md-6 pb-3 pb-md-0">
        {!! Form::label('idJabatan', 'Jabatan', ['class' => 'mb-1']) !!}
        {!! Form::select('id_jabatan', $jabatan, null, ['class' => 'form-control', 'id' => 'idJabatan']) !!}  
    </div>
</div>
