    ...
    static public function set($penilaian)
    {
        return Datatables::of($penilaian)
            ...
            ->addColumn('action', function ($penilaian) {
                ...
                return
                    '<div class="btn-group">' .
                    '<a href="' . (Auth::user()->isAdmin() ? route('penilaian.edit', $penilaian->id) : route('penilaian.edit_prilaku', $penilaian->id)) . '" class="btn  btn-sm  btn-warning ' . $hide . ' " data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit" style="margin-right: 5px" ><b> Nilai </b></a>' .
